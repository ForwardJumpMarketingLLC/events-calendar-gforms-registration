...
function init() {
	...
	$config = include_once EC_GF_CONFIG_DIR . '/post-metabox-config.php';
...
function enqueue_assets() {
	...
	wp_enqueue_style( 'ec_gf_styles', EC_GF_URL . '/assets/css/ec-gf-admin-styles.css', null, '0.1.0' );
	wp_enqueue_script( 'ec_gf_scripts', EC_GF_URL . '/assets/js/ec-gf-admin-scripts.js', [ 'jquery' ], '0.1.0', true );
}
